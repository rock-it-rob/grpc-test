...
public final class EchoServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<rob.proto.grpc.api.EchoApi.EchoRequest,
      rob.proto.grpc.api.EchoApi.EchoResponse> METHOD_ECHO = getEchoMethodHelper();

  private static volatile io.grpc.MethodDescriptor<rob.proto.grpc.api.EchoApi.EchoRequest,
      rob.proto.grpc.api.EchoApi.EchoResponse> getEchoMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<rob.proto.grpc.api.EchoApi.EchoRequest,
      rob.proto.grpc.api.EchoApi.EchoResponse> getEchoMethod() {
    return getEchoMethodHelper();
  }

  private static io.grpc.MethodDescriptor<rob.proto.grpc.api.EchoApi.EchoRequest,
      rob.proto.grpc.api.EchoApi.EchoResponse> getEchoMethodHelper() {
    io.grpc.MethodDescriptor<rob.proto.grpc.api.EchoApi.EchoRequest, rob.proto.grpc.api.EchoApi.EchoResponse> getEchoMethod;
      ...
      synchronized (EchoServiceGrpc.class) {
        if ((getEchoMethod = EchoServiceGrpc.getEchoMethod) == null) {
          EchoServiceGrpc.getEchoMethod = getEchoMethod = 
              io.grpc.MethodDescriptor.<rob.proto.grpc.api.EchoApi.EchoRequest, rob.proto.grpc.api.EchoApi.EchoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "EchoService", "Echo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  rob.proto.grpc.api.EchoApi.EchoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  rob.proto.grpc.api.EchoApi.EchoResponse.getDefaultInstance()))
  ...
  public static abstract class EchoServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void echo(rob.proto.grpc.api.EchoApi.EchoRequest request,
        io.grpc.stub.StreamObserver<rob.proto.grpc.api.EchoApi.EchoResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                rob.proto.grpc.api.EchoApi.EchoRequest,
                rob.proto.grpc.api.EchoApi.EchoResponse>(
                  this, METHODID_ECHO)))
          .build();
    }
  }
  ...
  public static final class EchoServiceBlockingStub extends io.grpc.stub.AbstractStub<EchoServiceBlockingStub> {
    ...
    /**
     */
    public rob.proto.grpc.api.EchoApi.EchoResponse echo(rob.proto.grpc.api.EchoApi.EchoRequest request) {
  ...
  public static final class EchoServiceFutureStub extends io.grpc.stub.AbstractStub<EchoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<rob.proto.grpc.api.EchoApi.EchoResponse> echo(
        rob.proto.grpc.api.EchoApi.EchoRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ECHO:
          serviceImpl.echo((rob.proto.grpc.api.EchoApi.EchoRequest) request,
              (io.grpc.stub.StreamObserver<rob.proto.grpc.api.EchoApi.EchoResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EchoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return rob.proto.grpc.api.EchoApi.getDescriptor();
    }
